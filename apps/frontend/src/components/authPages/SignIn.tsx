...
const handleLoginSuccess = (data: any) => {
  ...
  const handlePasswordLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://agrolink-updated-2-4.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const handleRequestOtp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://agrolink-updated-2-4.onrender.com/api/auth/login-with-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleVerifyOtp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://agrolink-updated-2-4.onrender.com/api/auth/verify-login-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
